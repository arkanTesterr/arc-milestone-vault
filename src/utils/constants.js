...
export const ARC_TESTNET = {
  chainId:    import.meta.env.VITE_CHAIN_ID || '1114',
  chainIdHex: '0x' + Number(import.meta.env.VITE_CHAIN_ID || 1114).toString(16),
  chainName:  'Arc Testnet',
  rpcUrl:     import.meta.env.VITE_RPC_URL || 'https://testnet-rpc.arc.xyz',
